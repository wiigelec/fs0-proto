...
def check_accepted_state_publication(root, assertion_ids):
    ...
    accepted_push = 'f"{candidate}:refs/heads/main"'
...
def check_bootstrap_read_surfaces(root, assertion_ids):
    ...
    expected_seed_ids = {'REPO-SPEC-PROPOSAL-FRAMEWORK-CONTRACT', 'REPO-SPEC-PROPOSAL-GOVERNANCE', 'REPO-SPEC-PROPOSAL-VALIDATION', 'REPO-SPEC-PROPOSAL-CONFORMANCE', 'REPO-SPEC-PROPOSAL-ASSURANCE', 'REPO-SPEC-PROPOSAL-SUCCESSOR-CONCEPTS'}
    seed_complete = set(proposal_ids) == expected_seed_ids and len(proposal_ids) == 6
